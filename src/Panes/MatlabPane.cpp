...
bool MatlabPane::Init()
{
	return true;
}

void MatlabPane::Unit()
{

}

int MatlabPane::DrawPanes(int vWidgetId, std::string vUserDatas)
{
...
void MatlabPane::DrawDialogsAndPopups(std::string vUserDatas)
{
...
int MatlabPane::DrawWidgets(int vWidgetId, std::string vUserDatas)
{
	UNUSED(vUserDatas);
...
std::string MatlabPane::getXml(const std::string& vOffset, const std::string& vUserDatas)
{
	UNUSED(vOffset);
	UNUSED(vUserDatas);
...
bool MatlabPane::setFromXml(tinyxml2::XMLElement* vElem, tinyxml2::XMLElement* vParent, const std::string& vUserDatas)
{
	UNUSED(vUserDatas);
...
void MatlabPane::ConnectToMatlabView(ct::cWeak<MatlabView> vMatlabView)
{
	m_MatlabView = vMatlabView;
}
...
void MatlabPane::DrawView()
{
	auto matlabViewPtr = m_MatlabView.getValidShared();
	if (matlabViewPtr)
	{
		matlabViewPtr->DrawView();
	}
}